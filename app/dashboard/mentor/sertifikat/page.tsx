  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Mahasiswa", value: stats.total, desc: "Bimbingan Terdaftar", icon: User, color: "text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/30 border-indigo-200/50 dark:border-indigo-900/40" },
      ...
      <div className="glass-card border border-slate-200/50 dark:border-slate-800/80 rounded-3xl p-5 md:p-6 shadow-sm bg-white dark:bg-[#070e24]/40 space-y-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h4 className="font-extrabold text-sm text-slate-900 dark:text-white">Pencarian & Penyaringan Dokumen</h4>
        </div>
          ...
          <table className="w-full min-w-[800px] border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 text-xs">
              {isLoading ? (
                ...
                return (
                  <tr key={cert.studentId} className="hover:bg-slate-50/70 dark:hover:bg-slate-900/30 transition-colors group">
                    ...
                    <td className="py-4">
                      <Link href={`/dashboard/mentor/sertifikat/${cert.studentId}`} className="inline-flex items-center gap-1 text-slate-700 dark:text-slate-300 font-bold">
