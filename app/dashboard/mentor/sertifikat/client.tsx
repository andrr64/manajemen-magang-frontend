...
export default function MentorCertificatePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* HEADER SECTION */}
      <PageHeader
        title="Pengelolaan Sertifikat Magang Mahasiswa"
        subtitle="Unggah berkas sertifikat formal bagi mahasiswa bimbingan yang telah menyelesaikan rangkaian magang industri dengan sukses."
        action={
          <button
